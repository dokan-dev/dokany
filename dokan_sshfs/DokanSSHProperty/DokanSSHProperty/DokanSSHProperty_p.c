...
typedef struct _DokanSSHProperty_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } DokanSSHProperty_MIDL_TYPE_FORMAT_STRING;

typedef struct _DokanSSHProperty_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } DokanSSHProperty_MIDL_PROC_FORMAT_STRING;

typedef struct _DokanSSHProperty_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } DokanSSHProperty_MIDL_EXPR_FORMAT_STRING;
...
extern const DokanSSHProperty_MIDL_TYPE_FORMAT_STRING DokanSSHProperty__MIDL_TypeFormatString;
extern const DokanSSHProperty_MIDL_PROC_FORMAT_STRING DokanSSHProperty__MIDL_ProcFormatString;
extern const DokanSSHProperty_MIDL_EXPR_FORMAT_STRING DokanSSHProperty__MIDL_ExprFormatString;
...
static const DokanSSHProperty_MIDL_PROC_FORMAT_STRING DokanSSHProperty__MIDL_ProcFormatString =
    {
        0,
        {
...
static const DokanSSHProperty_MIDL_TYPE_FORMAT_STRING DokanSSHProperty__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO ISSHProperty_ProxyInfo =
    {
    &Object_StubDesc,
    DokanSSHProperty__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    DokanSSHProperty__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _DokanSSHProperty_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ISSHPropertyProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _DokanSSHProperty_StubVtblList[] = 
{
